...
export class PromotionsComponent implements OnInit {
  ...
  constructor(
    ...
    private constantService: ApiConfigService
  ) {
  ...
  establecerTiempoPromo(date: any) {
    ...
    let diasEnMilisegundos =
      1000 * 60 * 60 * 24 * this.constantService.tiempoDias;
  ...
  openDialogAddPromos(templateRef: TemplateRef<any>) {
    ...
    this.isUpdate = false;
    this.title = "¿Deseas registrar una nueva promoción?";
    this.textEnd = "Ya has terminado presiona agregar para crear la promoción.";
  ...
  openDialogUpdatePromo(promo: Promos, templateRef: TemplateRef<any>) {
    ...
    this.title = "¿Deseas actualizar la promoción?";
